...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.selectedList.setColumnCount(2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(0, _translate("MainWindow", "斗鱼"))
        self.comboBox.setItemText(1, _translate("MainWindow", "虎牙"))
